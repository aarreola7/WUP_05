...
In this writ up we used my tricks rmd.Dplyr to make the triUmp group into an even smaller group called DRUGUSR. We saw how the drug and the placebo worked in getting a positive result for an effective drug. The drug users had a positive results showing us that the drug was in fact effective, and we can see those results in the graphical and numerical data.The results from the inferential test confirms that the drug was in fact a working drug.
